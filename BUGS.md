...
> Oluşturulma: 2026-06-30 (salt-tespit) · Son güncelleme: 2026-07-01 (PARTİ 4 — envanter sıfırlandı)
> **Durum:** 18 bulgunun 17'si ✅ FIXED. Kalan 1 madde (leaked-password) kod değil, kullanıcının elle yapacağı bir Supabase Dashboard ayarı (⏳). **Açık kod bug'ı: 0.**
...
| ⚪ **Düşük** | 7 | ✅ landing layout import (PARTİ 4), ✅ search_path mutable (PARTİ 1), ⏳ leaked-password (kullanıcı aksiyonu), ✅ ölü kolonlar (PARTİ 4), ✅ migration isim sapması (PARTİ 3), ✅ PROGRESS.md drift (PARTİ 4), ✅ mobile realtime unpublish (PARTİ 4) |
| **TOPLAM** | **18** | **17 ✅ FIXED**, 0 açık kod bug'ı, 1 ⏳ kullanıcı aksiyonu (Supabase Dashboard ayarı) |
