...
> Son güncelleme: 2026-07-20 (**Parti 2.2.D — set bazlı UI, uçtan uca kablolama** — program builder artık egzersiz başına tek satırlık grid yerine set listesi kullanıyor (kg/%1RM/vücut ağırlığı/direnç bandı + RPE, set başına), `exercise_sets` tablosuna yazıyor/okuyor. Detay: § Parti 2.2.D)
