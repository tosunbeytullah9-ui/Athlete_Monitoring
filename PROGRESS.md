...
> Son güncelleme: 2026-07-20 (**Parti 2.2.C — ExerciseList paylaşılan bileşene taşındı (davranış değişikliği yok)** — new/edit program builder'daki birebir aynı egzersiz listesi alt-bileşeni `apps/web/components/features/program-builder/exercise-list.tsx`'e çıkarıldı. Detay: § Parti 2.2.C)
