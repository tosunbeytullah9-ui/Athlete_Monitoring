...
export function NewProgramClient({ orgId, teams, athletes }: Props) {
  ...
  async function onSubmit(data: ProgramForm) {
    ...
    try {
      ...
      // Supabase TypeScript: from() tipini explicit cast ile çöz
...
import type { UseFormRegister, Control, UseFormWatch, FieldValues } from "react-hook-form";
